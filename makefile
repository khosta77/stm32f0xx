...
-include sources.mk
#-include system/src/stm32f0-hal/subdir.mk
...
main.elf: $(OBJS) $(USER_OBJS) makefile objects.mk $(OPTIONAL_TOOL_DEPS)
	...
	arm-none-eabi-g++ -mcpu=cortex-m0 -mthumb -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -g3 -T mem.ld -T libs.ld -T sections.ld -nostartfiles -Xlinker --gc-sections -L"./ldscripts" -Wl,-Map,"main.map" --specs=nano.specs -o "main.elf" $(OBJS) $(USER_OBJS) $(LIBS)
